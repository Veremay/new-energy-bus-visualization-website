...
import { ReactComponent as Charcoal } from "../assets/svg/charcoal-up.svg";
import { ReactComponent as Frontwheels } from "../assets/svg/charcoal-front-wheels1.svg";
...
const ScrollCar = ({ scrollContainerRef }) => {
  ...
  const car1 = {'body': <Charcoal />, 'back_wheels': <Backwheels />, 'front_wheels': <Frontwheels />, 'pollution': <Pollution />};
  const cars = [car1];
