...
import { ReactComponent as Diesel } from "../assets/svg/diesel-up.svg";
import { ReactComponent as Frontwheels } from "../assets/svg/diesel-frontwheels.svg";
import { ReactComponent as Backwheels } from "../assets/svg/diesel-backwheels.svg";
import { ReactComponent as Pollution} from "../assets/svg/diesel-pollution.svg"
...
const ScrollCar = ({ scrollContainerRef }) => {
  ...
  const car1 = {'body': <Diesel />, 'back_wheels': <Backwheels />, 'front_wheels': <Frontwheels />, 'pollution': <Pollution />};
  const cars = [car1];
